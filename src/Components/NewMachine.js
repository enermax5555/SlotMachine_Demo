    ...
    return (
        <main>
          <div className="flex-col h-screen justify-center m-auto content-center bg-center bg-no-repeat max-h-screen overflow-y-auto" style={{ backgroundImage: `url(${background})`,  backgroundSize:'cover'}}>
            ...
            <div className={isWin ? 'absolute justify-center text-center w-96 h-28 bg-no-repeat animate-bounce rounded-full overflow-hidden bg-contain lg:left-1/3 lg:ml-16 top-10' : 'hidden'} style={{backgroundImage: `url(${winner})`}}></div>
            </div>
