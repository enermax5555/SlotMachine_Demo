    ...
    return (
        <main>
          <div className="flex-col h-screen justify-center m-auto content-center bg-center bg-no-repeat max-h-screen overflow-y-auto" style={{ backgroundImage: `url(${background})`,  backgroundSize:'cover'}}>
            ...
            <div className={isWin ? 'fixed justify-center text-center w-96 h-28 bg-no-repeat animate-bounce rounded-full overflow-hidden bg-contain lg:left-96 top-10 lg:ml-20' : 'hidden'} style={{backgroundImage: `url(${winner})`}}></div>
            </div>
